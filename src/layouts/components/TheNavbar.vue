  ...
  <div class="relative">
    <div class="vx-navbar-wrapper">
      <vs-navbar class="vx-navbar navbar-custom" :color="navbarColor" :class="classObj">
        ...
        <!-- SEARCHBAR -->
        <div
          class="search-full-container w-full h-full absolute right-0 rounded-lg"
        ...
        <!-- QUICK MENU -->
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer ml-4">
          <img :src="require('@/assets/images/ham.png')" class="cursor-pointer" alt />
          <vs-dropdown-menu class="notification-dropdown dropdown-custom vx-navbar-dropdown">
            <vs-row vs-justify="space-around">
              <vs-col
                ...
                vs-align="flex-start"
                vs-w="6"
                style="border-right: 1px solid #eee; flex-flow: column; cursor: pointer; padding-top: 12px"
              >
                <router-link
                  :to="`/app${singleMenu.url}`"
                  v-for="(singleMenu,i) in topMenu"
                  :key="`${i}_singlemenu`"
                  class="flex justify-start flex-wrap w-full mt-5 mb-5 top-menu-drop"
                >
                  <feather-icon :icon="singleMenu.icon" />
                  <span class="ml-2">{{ singleMenu.title }}</span>
                </router-link>
              </vs-col>
              <vs-col
                vs-type="flex"
              ...
              >
                <router-link
                  :to="`/app${singleMenu.url}`"
                  v-for="(singleMenu,i) in topMenu2"
                  :key="`${i}_singlemenu02`"
                  class="flex justify-start flex-wrap w-full mt-5 mb-5 top-menu-drop"
